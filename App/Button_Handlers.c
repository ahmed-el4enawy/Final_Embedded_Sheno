...
void Buttons_Init(ElevatorContext *ctx) {
    ...
    /* ---- Floor sensors (pull-up, falling edge — same as buttons) ---- */
    Gpio_Init(FLOOR_SENS_PORT, FLOOR_SENS_PIN_F1, GPIO_INPUT, GPIO_PULL_UP);
    Gpio_Init(FLOOR_SENS_PORT, FLOOR_SENS_PIN_F2, GPIO_INPUT, GPIO_PULL_UP);
    Gpio_Init(FLOOR_SENS_PORT, FLOOR_SENS_PIN_F3, GPIO_INPUT, GPIO_PULL_UP);
    Gpio_Init(FLOOR_SENS_PORT, FLOOR_SENS_PIN_F4, GPIO_INPUT, GPIO_PULL_UP);

    Exti_Init(FLOOR_SENS_PIN_F1, FLOOR_SENS_EXTI_PORT, EXTI_EDGE_FALLING, FloorSensor_F1);
    Exti_Init(FLOOR_SENS_PIN_F2, FLOOR_SENS_EXTI_PORT, EXTI_EDGE_FALLING, FloorSensor_F2);
    Exti_Init(FLOOR_SENS_PIN_F3, FLOOR_SENS_EXTI_PORT, EXTI_EDGE_FALLING, FloorSensor_F3);
    Exti_Init(FLOOR_SENS_PIN_F4, FLOOR_SENS_EXTI_PORT, EXTI_EDGE_FALLING, FloorSensor_F4);
